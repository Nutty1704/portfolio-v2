  ...
  return (
    <div className="flex gap-4">
      <div className="flex flex-col gap-0 items-center pb-1.5">
        <div className={`anim-circle bg-${color} h-4 w-4 rounded-full`} />
        <div className={`anim-line h-full w-[2px] bg-${color} rounded-full opacity-30`} />
      </div>
      <div className="anim-text space-y-2 flex-1">
